...
def quality_threshold() -> str:
    return _get_name_from_file("quality_threshold")
...
def quality_computing_method() -> str:
    return _get_name_from_file("quality_computing_method")


def clustering_trees_method() -> str:
    return _get_name_from_file("clustering_trees_method")
...
def subsubtrain_directory() -> str:
    return _get_name_from_file("subsubtrain_directory")


def true_class_directory() -> str:
    return _get_name_from_file("true_class_directory")


def classes_matrices_directory() -> str:
    return _get_name_from_file("classes_matrices_directory")


def clustering_trees_directory() -> str:
    return _get_name_from_file("clustering_trees_directory")
...
def encoding_input() -> str:
    return _get_name_from_file("encoding_input")


def encoding_output() -> str:
    return _get_name_from_file("encoding_output")


def format_input() -> str:
    return _get_name_from_file("format_input")


def format_output() -> str:
    return _get_name_from_file("format_output")


def delimiter_input() -> str:
    return _get_name_from_file("delimiter_input")


def delimiter_output() -> str:
    return _get_name_from_file("delimiter_output")


def quoting_input() -> str:
    return _get_name_from_file("quoting_input")


def quoting_output() -> str:
    return _get_name_from_file("quoting_output")


def quote_char_input() -> str:
    return _get_name_from_file("quote_char_input")
