...
def quality_threshold() -> str:
    return _get_doc_from_file("quality_threshold")
...
def quality_computing_method() -> str:
    return _get_doc_from_file("quality_computing_method")


def clustering_trees_method() -> str:
    return _get_doc_from_file("clustering_trees_method")
...
def clustering_trees_prefix() -> str:
    return _get_doc_from_file("clustering_trees_prefix")
...
def true_class_directory() -> str:
    return _get_doc_from_file("true_class_directory")
...
def clustering_trees_directory() -> str:
    return _get_doc_from_file("clustering_trees_directory")
...
def last_phase() -> str:
    return _get_doc_from_file("last_phase")


def resume_phase() -> str:
    return _get_doc_from_file("resume_phase")
...
def line_delimiter_input() -> str:
    return _get_doc_from_file("line_delimiter_input")


def line_delimiter_output() -> str:
    return _get_doc_from_file("line_delimiter_output")
